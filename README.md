...
- `shopping-agent_safe.eide` — the correct design.
- `shopping-agent_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
